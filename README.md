...
The node authenticates with a machine-to-machine **JWT access token** issued by the NordStellar IAM API. Create a credential of type **NordStellar Integration API** and provide:
